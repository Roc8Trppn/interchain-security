...
To suggest an ADR, please make use of the [ADR template](https://github.com/Roc8Trppn/interchain-security/blob/main/docs/docs/adrs/templates/adr-template.md) provided.
